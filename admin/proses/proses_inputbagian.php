...
if (
	!($nama_bagian == '') and !($username_admin_bagian == '') and !($password_bagian == '') and !($nama_lengkap == '') and !($tgl_lahir == '') and !($nip == '') and !($golongan == '') and !($alamat == '') and !($no_hp_bagian == '') and
	...
	$sql = "INSERT INTO tb_bagian(nama_bagian, username_admin_bagian, password_bagian, nama_lengkap, tanggal_lahir_bagian, nip, golongan, alamat, no_hp_bagian, gambar)
				values ('$nama_bagian', '$username_admin_bagian', '$password_bagian', '$nama_lengkap', '$tgl_lahir', '$nip','$golongan','$alamat', '$no_hp_bagian', '$nama_baru')";
	$execute = mysqli_query($db, $sql);

	echo "<Center><h2><br>Terima Kasih<br>Pegawai Telah Didaftarkan ke Sistem</h2></center>
