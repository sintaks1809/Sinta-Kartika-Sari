                ...
                <div class="">
                    <div class="page-title">
                        <div class="title_right">
                            <h2>LAPORAN SPPD DALAM DAERAH</h2>
                        </div>
                    </div>
                    ...
                    <form method="get" action="">
                        ...
                        <div id="form-tahun">
                            ...
                            <select name="tahun">
                                <option value="">Pilih</option>
                                <?php
                                $query = "SELECT YEAR(tgl_spt) AS tahun FROM tb_dalamdaerah GROUP BY YEAR(tgl_spt)"; // Tampilkan tahun sesuai di tabel transaksi
                        ...
                        <a href="laporan_perjalanandalam.php" class="btn btn-warning">Reset Filter</a>
                    </form>
                    <hr />
                    <?php
                    if (isset($_GET['filter']) && !empty($_GET['filter'])) { // Cek apakah user telah memilih filter dan klik tombol tampilkan
                        ...
                        if ($filter == '2') { // Jika filter nya 2 (per bulan)
                            ...
                            echo '<a href="print_perjalanandalam.php?filter=2&bulan=' . $_GET['bulan'] . '&tahun=' . $_GET['tahun'] . '"class="btn btn-primary">Cetak PDF</a><br /><br />';
                            ...
                            echo '<a href="print_perjalanandalam.php?filter=3&tahun=' . $_GET['tahun'] .  '" class="btn btn-primary">Cetak PDF</a><br /><br />';
                        ...
                        echo '<a href="print_perjalanandalam.php" class="btn btn-primary">Cetak PDF</a><br /><br />';
