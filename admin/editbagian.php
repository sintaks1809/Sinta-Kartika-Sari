                ...
                <div class="x_title">
                  ...
                  <form action="proses/proses_editbagian.php" method="post" enctype="multipart/form-data" id="demo-form2" name="formupdate" data-parsley-validate class="form-horizontal form-label-left">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-9 col-sm-9 col-xs-12">
                        <input value="<?php echo $data['nip']; ?>" type="text" id="nip" name="nip" required="required" maxlength="70" placeholder="Masukkan NIP" class="form-control col-md-7 col-xs-12">
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-9 col-sm-9 col-xs-12">
                        <select value="<?php echo $data['golongan']; ?>" name="golongan" class="form-control" required>
