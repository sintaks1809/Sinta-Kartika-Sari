                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                <div class="x_title">
                                    ...
                                    <br />
                                    <form action="proses/proses_editnamabagian.php" method="post" enctype="multipart/form-data" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9 col-sm-9 col-xs-12">
                                                <input value="<?php echo $data['nama_bagian']; ?>" type="text" id="nama_bagian" name="nama_bagian" required="required" placeholder="Masukkan Nama Jabatan " class="form-control col-md-7 col-xs-12">
                                            </div>
                                        </div>
