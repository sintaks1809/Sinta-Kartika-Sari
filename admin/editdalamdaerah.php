                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                <div class="x_title">
                                    <br>
                                    <p>
                                    <form action="proses/proses_editdalamdaerah.php" method="post" enctype="multipart/form-data" id="demo-form2" name="formupdate" data-parsley-validate class="form-horizontal form-label-left">
                                        <?php include '../koneksi/koneksi.php';
                                        $id      = mysqli_real_escape_string($db, $_GET['id_dalamdaerah']);
                                        ...
                                        <input type=hidden name="id_dalamdaerah" value="<?php echo $id; ?>">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9 col-sm-9 col-xs-12">
                                                <img src="sptdalam/<?php echo $data['gambar']; ?>" class="img-circle" height="80" width="80" style="border: 2px solid #666666;" />
                                            </div>
                                        </div>
