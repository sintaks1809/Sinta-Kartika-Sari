...
<head>
  ...
  <!-- bootstrap-daterangepicker -->
  <link href="../assets/vendors/bootstrap-daterangepicker/daterangepicker.css" rel="stylesheet">
  <link rel="shortcut icon" href="../img/bawaslu.jpg">
                ...
                <div class="x_title">
                  ...
                  <form action="proses/proses_inputbagian.php" name="formbagian" method="post" enctype="multipart/form-data" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                    <div class="form-group">
                      ...
                      <div class="col-md-9 col-sm-9 col-xs-12">
                        <select name="nama_bagian" class="form-control" required>
                          ...
                          $nama_bagian = mysqli_query($db, "SELECT nama_bagian FROM tb_nama_bagian");
                          while ($hasil = mysqli_fetch_array($nama_bagian)) {
                            echo "<option>$hasil[nama_bagian]</option>";
                          }
                          ?>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-9 col-sm-9 col-xs-12">
                        <input type="text" id="username_admin_bagian" name="username_admin_bagian" required="required" maxlength="50" placeholder="Masukkan Username " class="form-control col-md-7 col-xs-12">
                      </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-9 col-sm-9 col-xs-12">
                        <input type="text" id="nip" name="nip" required="required" maxlength="70" placeholder="Masukkan NIP" class="form-control col-md-7 col-xs-12">
                      </div>
                    </div>

                    <div class="form-group">
                      <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">Golongan<span class="required">*</span>
                      </label>
                      <div class="col-md-9 col-sm-9 col-xs-12">
                        <select name="golongan" class="form-control" required>
                          ...
                          <?php
                          include '../koneksi/koneksi.php';
                          $golongan = mysqli_query($db, "SELECT golongan FROM tb_golongan");
                          while ($hasil = mysqli_fetch_array($golongan)) {
                            echo "<option>$hasil[golongan]</option>";
                          }
                          ?>
                        </select>
                      </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-9 col-sm-9 col-xs-12">
                        <input type="number" onkeyup="validAngka(this)" id="no_hp_bagian" name="no_hp_bagian" required="required" maxlength="12" placeholder="Masukkan Nomor HP" class="form-control col-md-7 col-xs-12">
                      </div>
                    </div>
                    <div class="form-group">
