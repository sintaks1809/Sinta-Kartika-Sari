            ...
            <div class="">
              <div class="x_content">
                <div class="row">
                  ...
                  $sql1    = "SELECT * FROM tb_dalamdaerah";
                  ...
                  <?php include '../koneksi/koneksi.php';
                  $sql2    = "SELECT * FROM tb_luardaerah";
                  ...
                  <?php include '../koneksi/koneksi.php';
                  $sql1    = "SELECT * FROM tb_barangbaru";
                  $query1    = mysqli_query($db, $sql1);
                  $jumlah1   = mysqli_num_rows($query1);
                  ?>
                  <div class="animated flipInY col-lg-4 col-md-4 col-sm-6 col-xs-12">
                  ...
                  <?php include '../koneksi/koneksi.php';
                  $sql1    = "SELECT * FROM tb_barangrusak";
                  $query1    = mysqli_query($db, $sql1);
                  $jumlah1   = mysqli_num_rows($query1);
                  ?>
                  <div class="animated flipInY col-lg-4 col-md-4 col-sm-6 col-xs-12">
                  ...
                  <?php include '../koneksi/koneksi.php';
                  $sql1    = "SELECT * FROM tb_nama_bagian";
                  $query1    = mysqli_query($db, $sql1);
                  $jumlah1   = mysqli_num_rows($query1);
                  ?>
                  <div class="animated flipInY col-lg-4 col-md-4 col-sm-6 col-xs-12">
