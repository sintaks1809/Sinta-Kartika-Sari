...
<body onLoad="window.print()">
    ...
    <div style="text-align: center;">
        <font size="4"><b><u>LAPORAN DATA BARANG RUSAK</u></b></font><br>
    </div>
    <br>
    ...
    <body>
        ...
        if (isset($_GET['filter']) && !empty($_GET['filter'])) { // Cek apakah user telah memilih filter dan klik tombol tampilkan
            ...
            if ($filter == '2') { // Jika filter nya 2 (per bulan)
                ...
                echo '<b>Data Barang Rusak Perbulan ' . $nama_bulan[$_GET['bulan']] . ' ' . $_GET['tahun_anggaran'] . ' ' . $_GET['keterangan'] . '</b></b>';

                echo '<a href="print_barangrusak.php?filter=2&bulan=' . $_GET['bulan'] . '&tahun_anggaran=' . $_GET['tahun_anggaran'] . '&keterangan=' . $_GET['keterangan'] . '"class="btn btn-primary"></a></b></b>';
                ...
                echo '<b>Data Barang Rusak Pertahun  ' . $_GET['keterangan'] . ' ' . $_GET['tahun_anggaran'] . '</b></b></br>';
                ...
                echo '<b>Data Barang Rusak Pertahun  ' . $_GET['tahun_anggaran'] . '</b></b></b>';
                echo '<a href="print_barangrusak.php?filter=3&tahun_anggaran=' . $_GET['tahun_anggaran'] . '&keterangan=' . $_GET['keterangan'] . '" class="btn btn-primary"></a></b></b>';
            ...
            echo '<b>Semua Data Barang Rusak  </b><br/></b>';
