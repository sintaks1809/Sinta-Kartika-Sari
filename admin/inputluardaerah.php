                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                <div class="x_title">
                                    ...
                                    <br />
                                    <form action="proses/proses_inputluar.php" name="formspdluardaerah" method="post" enctype="multipart/form-data" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">

                                        <?php include '../koneksi/koneksi.php';
                                        $carikode = mysqli_query($db, "SELECT max(kode) FROM tb_luardaerah") or die(mysqli_error($db));
