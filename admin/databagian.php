        ...
        <div class="">
          ...
          <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="x_panel">
                <div class="x_title">
                  <a href="inputbagian.php"><button type="button" class="btn btn-success"><i class="fa fa-plus"></i> Tambah Data Pegawai</button></a>
                  <p>
                    <br>
                    ...
                    $no = 1;
                    if ($total == 0) {
                      echo "<center><h2>Belum Ada Data Pengguna</h2></center>";
                    } else { ?>
