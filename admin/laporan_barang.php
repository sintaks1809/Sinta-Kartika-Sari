                ...
                <div class="">
                    ...
                    <form method="get" action="">
                        ...
                        <select name="filter" id="filter">
                            ...
                            <option value="4">Per Ruangan</option>
                        ...
                        <div id="form-tahun">
                            ...
                            <select name="tahun">
                                <option value="">Pilih</option>
                                <?php
                                $query = "SELECT YEAR(tahun_anggaran) AS tahun FROM tb_barangbaru GROUP BY YEAR(tahun_anggaran)"; // Tampilkan tahun sesuai di tabel transaksi
                        ...
                        <a href="laporan_barang.php" class="btn btn-warning">Reset Filter</a>
                    </form>
                    <hr />
                    <?php
                    if (isset($_GET['filter']) && !empty($_GET['filter'])) { // Cek apakah user telah memilih filter dan klik tombol tampilkan
                        ...
                        if ($filter == '2') { // Jika filter nya 2 (per bulan)
                            ...
                            echo '<b>Data Barang Perbulan ' . $nama_bulan[$_GET['bulan']] . ' ' . $_GET['tahun'] . ' ' . $_GET['ruangan'] . '</b><br /><br />';

                            echo '<a href="print_barang.php?filter=2&bulan=' . $_GET['bulan'] . '&tahun=' . $_GET['tahun'] . '&ruangan=' . $_GET['ruangan'] . '"class="btn btn-primary">Cetak PDF</a><br /><br />';
                            ...
                            echo '<b>Data Barang Pertahun ' . $_GET['ruangan'] . '</b><br /><br />';
                            echo '<a href="print_barang.php?filter=4&ruangan=' . $_GET['ruangan'] . '" class="btn btn-primary">Cetak PDF</a><br /><br />';
                            ...
                            echo '<b>Data Barang Pertahun ' . $_GET['tahun'] . '</b><br /><br />';
                            echo '<a href="print_barang.php?filter=3&tahun=' . $_GET['tahun'] . '&ruangan=' . $_GET['ruangan'] . '" class="btn btn-primary">Cetak PDF</a><br /><br />';
                        ...
                        echo '<b>Semua Data Barang   </b><br /><br />';
                        echo '<a href="print_barang.php" class="btn btn-primary">Cetak PDF</a><br /><br />';
