            ...
            <div class="">
              <div class="x_content">
                <div class="row">
                  ...
                  $sql1    = "SELECT * FROM tb_luardaerah WHERE id_luardaerah";
                  ...
                  <?php include '../koneksi/koneksi.php';
                  $sql2    = "SELECT * FROM tb_dalamdaerah WHERE id_dalamdaerah";
                  ...
                  <?php include '../koneksi/koneksi.php';
                  $sql2    = "SELECT * FROM tb_barangbaru WHERE id_barang";
                  $query2    = mysqli_query($db, $sql2);
                  $jumlah1   = mysqli_num_rows($query2);
                  ?>
                  <div class="animated flipInY col-lg-6 col-md-4 col-sm-6 col-xs-12">
                    <div class="tile-stats">
                      <div class="icon"><i class=""></i>
                  ...
                  <?php include '../koneksi/koneksi.php';
                  $sql2    = "SELECT * FROM tb_barangrusak WHERE id_barang";
                  $query2    = mysqli_query($db, $sql2);
                  $jumlah1   = mysqli_num_rows($query2);
                  ?>
                  <div class="animated flipInY col-lg-6 col-md-4 col-sm-6 col-xs-12">
                  ...
                  <?php include '../koneksi/koneksi.php';
                  $sql2    = "SELECT * FROM tb_pengajuan WHERE id_pengajuan";
                  $query2    = mysqli_query($db, $sql2);
                  $jumlah1   = mysqli_num_rows($query2);
                  ?>
                  <div class="animated flipInY col-lg-6 col-md-4 col-sm-6 col-xs-12">
